---
title: Paraglide
description: Pair TanStack i18n locale routing with Paraglide compile-time messages.
---
...
<Callout type="info">
  **Runnable References:**
  - **React Start (SSR)**: [`examples/react/start/paraglide/`](https://github.com/Wadiou/tanstack-i18n/tree/main/examples/react/start/paraglide)
  - **React Router (SPA)**: [`examples/react/router/paraglide/`](https://github.com/Wadiou/tanstack-i18n/tree/main/examples/react/router/paraglide)
  - **Solid Start (SSR)**: [`examples/solid/start/paraglide/`](https://github.com/Wadiou/tanstack-i18n/tree/main/examples/solid/start/paraglide)
  - **Solid Router (SPA)**: [`examples/solid/router/paraglide/`](https://github.com/Wadiou/tanstack-i18n/tree/main/examples/solid/router/paraglide)
</Callout>
