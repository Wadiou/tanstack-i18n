...
<Callout type="info">
  **Runnable References:**
  - **React Start (SSR)**: [`examples/react/start/react-i18next/`](https://github.com/Wadiou/tanstack-i18n/tree/main/examples/react/start/react-i18next)
  - **React Router (SPA)**: [`examples/react/router/react-i18next/`](https://github.com/Wadiou/tanstack-i18n/tree/main/examples/react/router/react-i18next)
</Callout>
