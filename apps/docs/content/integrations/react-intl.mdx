...
<Callout type="info">
  **Runnable References:**
  - **React Start (SSR)**: [`examples/react/start/react-intl/`](https://github.com/Wadiou/tanstack-i18n/tree/main/examples/react/start/react-intl)
  - **React Router (SPA)**: [`examples/react/router/react-intl/`](https://github.com/Wadiou/tanstack-i18n/tree/main/examples/react/router/react-intl)
</Callout>
