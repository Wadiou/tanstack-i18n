...
description: Wire use-intl with TanStack i18n. Configure message catalogs, wrap routes in IntlProvider, and set up locale state syncing via beforeLoad.
---
...
<Callout type="info">
  **Runnable References:**
  - **React Start (SSR)**: [react-start-use-intl](/examples#react-start-use-intl)
  - **React Router (SPA)**: [react-router-use-intl](/examples#react-router-use-intl)
</Callout>
